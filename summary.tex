...
\end{itemize}% TODO Maybe finish this... although I don't know how, exactly
...
\item Path to the solution usually gets computed while searching for the best solution.% Whatever that means...
\end{itemize}
\begin{figure}[!htbp]
  \centering
